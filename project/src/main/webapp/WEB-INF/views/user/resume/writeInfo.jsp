...
<section class="resume_info_page">
				...
				<div class="resume_user_info">
					<div class="user_info__box">
						<div class="user_info_box_batch">
							<div class="user__name"><span style="font-size:10px;">이름<span style="color:red;">*</span></span><br>${resume.userNm }</div>
							<div class="user__birthday"><span style="font-size:10px;">생년월일<span style="color:red;">*</span></span><br>${resume.userBirthday }</div>
							<div class="user__phone"><span style="font-size:10px;">휴대폰번호<span style="color:red;">*</span></span><br>${resume.userPhoneNum }</div>
						</div>
						<div class="user_info_box_batch user_info_box_batch_two">
							...
							<div class="user__email"><span style="font-size:10px;">이메일<span style="color:red;">*</span></span><br>${resume.userEmail }</div>
						</div>
					</div>
					<div>
	...
	<div class="resume_update_button">
		<a href="/resume/update?resumeId=${resume.resumeId }">
